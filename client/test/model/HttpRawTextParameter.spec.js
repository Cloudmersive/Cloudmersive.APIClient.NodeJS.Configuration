...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConfigurationApiClient.HttpRawTextParameter();
  });
  ...
  describe('HttpRawTextParameter', function() {
    it('should create an instance of HttpRawTextParameter', function() {
      // uncomment below and update the code to test HttpRawTextParameter
      //var instance = new CloudmersiveConfigurationApiClient.HttpRawTextParameter();
      //expect(instance).to.be.a(CloudmersiveConfigurationApiClient.HttpRawTextParameter);
    });
