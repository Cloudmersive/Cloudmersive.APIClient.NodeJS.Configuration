...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConfigurationApiClient.HttpOrchestrationHeader();
  });
  ...
  describe('HttpOrchestrationHeader', function() {
    it('should create an instance of HttpOrchestrationHeader', function() {
      // uncomment below and update the code to test HttpOrchestrationHeader
      //var instance = new CloudmersiveConfigurationApiClient.HttpOrchestrationHeader();
      //expect(instance).to.be.a(CloudmersiveConfigurationApiClient.HttpOrchestrationHeader);
    });
