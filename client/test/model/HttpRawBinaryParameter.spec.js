...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConfigurationApiClient.HttpRawBinaryParameter();
  });
  ...
  describe('HttpRawBinaryParameter', function() {
    it('should create an instance of HttpRawBinaryParameter', function() {
      // uncomment below and update the code to test HttpRawBinaryParameter
      //var instance = new CloudmersiveConfigurationApiClient.HttpRawBinaryParameter();
      //expect(instance).to.be.a(CloudmersiveConfigurationApiClient.HttpRawBinaryParameter);
    });
